...
---
#### 回想当年（2014年）我面对秋招季，就像无头的苍蝇。到处寻找各大厂的面试题，却寥寥无几。
#### 而现在，面对这个充满挑战与机遇的时代，互联网大数据的崛起，要寻找的面试题不是什么难事，然而，却没有一个系统地、全面地面试题合辑。
#### 所以，为了现在面临找工作的程序员们，能够有个非常好的刷题去处，我毅然决心创建此仓。希望能给程序员的你，带来帮助!
##### 想要了解更多，秋招咨询、面试技巧、面试执导、简历制作等....可以加我的VX，备注"github面试题"
